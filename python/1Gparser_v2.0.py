...
def get_info (line):
   ...
   for i in range (len (alleles)):
      ...
      vnotation=getnotation(line)
      info.update({vnotation[i]:{"chromosome":words[0],"start":coords[0],"end":coords[1],"notation":vnotation[i],"referenceNT":words[3],"alternativeNT":allele,"type":vtype,"qScore":words[5],"filter":words[6],"rsID":words[2]}})
   return info
      ...
      while line:
         ...
         #   print "line "+str(i)
            ...
            for variant in info:
               ...
               com2="INSERT into has_variant (notation, personID, heterozygosity) values "
               people=""
